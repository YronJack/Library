...
public class ListingsActionsTest {
    ...
    void setUp() {
        ...
        hub.studentsList = Arrays.asList(s1, s2, s3);
        ...
        hub.issuesList = Arrays.asList(i1, i2, i3, i4, i5);
    ...
    @Test
        ...
        @Test
        void listBooksByUsnWithNoIssuesForUsn() {
            Scanner mockScanner = new Scanner("julia\n");
            ListingActions.listBooksByUsn(mockScanner, hub);
            String output = outContent.toString();
            assertTrue(output.contains("No books found for student with USN julia."));
        }
